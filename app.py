...
st.markdown(
    ...
    <div class="description">
        This chatbot is a research-driven application designed by Riley Kim, leveraging RAG.<br>
        It enables natural language interaction by combining semantic retrieval with LLM.
    </div>
    """,
